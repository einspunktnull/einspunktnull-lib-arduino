...
SAAPSerial::SAAPSerial()
{
}

void SAAPSerial::initialize(ErrorFunctionPointer errorFctPtr, HardwareSerial *serialPtr, long baudrate, unsigned long timeout)
{
...
void SAAPSerial::registerCommand(const uint8_t command, FunctionPointer fctPtr, const uint8_t numArguments)
{
...
void SAAPSerial::onError(const uint8_t errorNum, const uint8_t command, const uint8_t numValues)
{
...
void SAAPSerial::countArguments()
{
...
void SAAPSerial::handleCommand(const bool msgComplete)
{
	if (!msgComplete)
	{
...
String SAAPSerial::getStringValue()
{
...
int SAAPSerial::getIntValue()
{
	return getStringValue().toInt();
}

float SAAPSerial::getFloatValue()
{
...
void SAAPSerial::send(String msg)
{
