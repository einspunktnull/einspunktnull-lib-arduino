...
void SAAP::initialize(ErrorFunctionPointer errorFctPtr, HardwareSerial *serialPtr, long baudrate, unsigned long timeout)
{
...
void SAAP::registerCommand(const uint8_t command, FunctionPointer fctPtr, const uint8_t numArguments)
{
...
int SAAP::getIntValue()
{
	return getStringValue().toInt();
}

float SAAP::getFloatValue()
{
...
void SAAP::send(String msg)
{
	_serialPointer->print(msg);
}

void SAAP::sendln(String msg)
{
